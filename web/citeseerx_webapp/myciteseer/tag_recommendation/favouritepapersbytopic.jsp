...
<br>
<center>
<h1>Folder [<%=foldername%>] by User <%=userid%>:<%=name%></h1>
</center>
<br>
...
<table border="1" align="center">
	...
	<%
		for (int i = 0; i < t_length; i++) {
			...
			String link = "taggingframe.jsp?did=" + u_paperid[i]
					+ "&userid=" + userid;
	%>
	<tr>
		<td><a href="<%=link%>"><%=u_papername[i]%> </a></td>
		<td>
		<%
		...
		%> <a href="<%=link1%>"><font
			size="<%=tempcount%>" color="<%=color%>"><%=tempname%></font></a> <%
 	}
 %>
		</td>
	</tr>
