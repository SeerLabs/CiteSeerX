<div id="sidebar">
  ...
  <div id="qother">Try your query at:
    ...
    <c:url value='http://academic.research.microsoft.com/Search.aspx' var="Libra"><c:param name="query" value='${ param.q }'/><c:param name="submit" value='Search'/></c:url>
    <table border="0" cellspacing="5" cellpadding="5" >
      <tr><td><a href="<c:out value='${ googleScholar }' escapeXml="true"/>" title="Google Scholar search engine">Scholar</a></td>
        ...
        <td><a href="<c:out value='${ ask }' escapeXml="true"/>" title="Ask.com Search Engine">Ask</a></td></tr>
      <tr><td><a href="<c:out value='${ Bing }' escapeXml="true"/>" title="Live Search is evolving">Bing</a></td>
        ...
        <td><a href="<c:out value='${ Libra }' escapeXml="true"/>" title="Libra">Libra</a></td></tr>
    </table>
  </div>
</div>